...
`),a())},styles:["pre[_ngcontent-%COMP%]{width:100%;height:100%;max-height:100%;overflow-y:auto;overflow-x:hidden;background-color:#121212;color:#e0e0e0;font-family:Courier New,monospace;font-size:.85rem;line-height:1.4;white-space:pre-wrap;word-wrap:break-word;padding:1rem;border-radius:6px;display:flex;flex-direction:column-reverse;box-sizing:border-box}"]})};var ve=class t{dataSource=Yt;childrenAccessor=r=>r.children??[];hasChild=(r,e)=>!!e.children&&e.children.length>0;ngAfterViewInit(){}static \u0275fac=function(e){return new(e||t)};static \u0275cmp=l({type:t,selectors:[["app-root"]],decls:17,vars:0,consts:[["drawer",""],["autosize",""],["mode","side","position","end"],["matMiniFab","",1,"button-drawer-close",3,"click"],[1,"drawer-container"],["matFab","","extended","",1,"button-drawer",3,"click"]],template:function(e,n){if(e&1){let i=U();o(0,"mat-drawer-container",1),m(1,"app-toolbar-layout")(2,"app-breadcrumb"),o(3,"app-container"),m(4,"router-outlet"),a(),m(5,"app-footer-layout"),o(6,"mat-drawer",2,0)(8,"button",3),g("click",function(){O(i);let f=J(7);return P(f.toggle())}),o(9,"mat-icon"),s(10,"close"),a()(),o(11,"div",4),m(12,"app-console"),a()(),o(13,"button",5),g("click",function(){O(i);let f=J(7);return P(f.toggle())}),o(14,"mat-icon"),s(15,"terminal"),a(),s(16," Console "),a()()}},dependencies:[S,he,ge,Y,Z,rt,le,Se,Fe,C,q,yt,fe,_e],styles:[":root{--mat-sidenav-container-width: 700px}mat-drawer-container[_ngcontent-%COMP%]{height:100vh;background-color:unset;box-sizing:border-box}mat-drawer[_ngcontent-%COMP%]{height:100vh;box-shadow:var(--mat-sys-level2);overflow:visible;z-index:1000}.button-drawer[_ngcontent-%COMP%]{position:fixed;top:100px;right:0;box-shadow:var(--mat-sys-level2);border-radius:var(--mat-sys-corner-large) 0 0 var(--mat-sys-corner-large)}.button-drawer-close[_ngcontent-%COMP%]:hover, .button-drawer-close[_ngcontent-%COMP%]{box-shadow:var(--mat-sys-level0);position:absolute;top:4px;right:4px;background-color:var(--mat-sys-surface-container);color:var(--mat-sys-error)}.drawer-container[_ngcontent-%COMP%]{padding:16px;margin-top:32px;height:calc(100% - 80px)}app-breadcrumb[_ngcontent-%COMP%], app-footer-layout[_ngcontent-%COMP%]{display:block;position:relative;left:var(--toolbar-width);width:calc(100vw - var(--toolbar-width))}"]})},Yt=[{name:"Experiments",children:[{name:"Motor Imagery",children:[{name:"MotorImageryUnilateral Motor Imagery",link:"/experiments/motor-imagery/unilateral"},{name:"Bilateral Motor Imagery",link:"/experiments/motor-imagery/bilateral"},{name:"Feet Motor Imagery",link:"/experiments/motor-imagery/feet"}]},{name:"P300"},{name:"SSVEP"}]}];function Xt(t,r){if(t&1){let e=U();o(0,"a",3),g("click",function(){let i=O(e).$implicit,h=u();return P(h.activeNavLink=i.url)}),s(1),a()}if(t&2){let e=r.$implicit,n=u();T("routerLink",e.url)("active",n.activeNavLink==e.url),d(),L(" ",e.label," ")}}var be=class t{constructor(r,e){this.document=r;this.navigationBarService=e;this.navigationBarService.activeNavLink$.subscribe(n=>{this.activeNavLink=n})}activeNavLink="/home";links=[{label:"Home",url:"/home"},{label:"Hardware",url:"/hardware"},{label:"Pricing",url:"/pricing"},{label:"Experiments",url:"/experiments"}];static \u0275fac=function(e){return new(e||t)(p(E),p(ht))};static \u0275cmp=l({type:t,selectors:[["app-navbar"]],decls:5,vars:1,consts:[["tabPanel",""],["mat-tab-nav-bar","","mat-stretch-tabs","false","mat-align-tabs","center",3,"tabPanel"],["mat-tab-link","",3,"routerLink","active"],["mat-tab-link","",3,"click","routerLink","active"]],template:function(e,n){if(e&1&&(o(0,"nav",1),D(1,Xt,2,3,"a",2,We),a(),m(3,"mat-tab-nav-panel",null,0)),e&2){let i=J(4);T("tabPanel",i),d(),I(n.links)}},dependencies:[j,ut,lt,mt,pt,C],styles:["nav[_ngcontent-%COMP%]{position:sticky;top:0;background-color:var(--mat-sys-primary-container);z-index:1000;padding:8px;box-shadow:var(--mat-sys-level2)}  :root{--mat-tab-divider-height: 0px}"]})};var ye=class t{constructor(r,e,n){this.document=r;this.themeService=e;this.sanitizer=n;this.currentMode=e.getCurrentMode()}currentMode="auto";setReactiveMode(r){this.themeService.setThemeMode(r),this.currentMode=r}static \u0275fac=function(e){return new(e||t)(p(E),p(F),p(Qe))};static \u0275cmp=l({type:t,selectors:[["app-landing-layout"]],decls:10,vars:4,consts:[[1,"theme-switcher"],["matIconButton","","id","mode-light",1,"mode-button",3,"click"],["matIconButton","","id","mode-dark",1,"mode-button",3,"click"]],template:function(e,n){e&1&&(m(0,"app-navbar")(1,"router-outlet")(2,"app-footer-layout"),o(3,"div",0)(4,"button",1),g("click",function(){return n.setReactiveMode("light")}),o(5,"mat-icon"),s(6,"light_mode"),a()(),o(7,"button",2),g("click",function(){return n.setReactiveMode("dark")}),o(8,"mat-icon"),s(9,"dark_mode"),a()()()),e&2&&(d(4),w("display",n.currentMode==="dark"?"flex":"none"),d(3),w("display",n.currentMode==="dark"?"none":"flex"))},dependencies:[S,be,Y,C,q,tt],styles:[".theme-switcher[_ngcontent-%COMP%]{position:fixed;top:8px;right:24px;background-color:var(--mat-sys-inverse-primary);border-radius:50%;width:50px;height:50px;display:flex;justify-content:center;align-items:center;z-index:1000}"]})};var xe=class t{constructor(r){this.themeService=r;this.currentMode=r.getCurrentMode()}currentMode="auto";setReactiveMode(r){this.themeService.setThemeMode(r),this.currentMode=r}static \u0275fac=function(e){return new(e||t)(p(F))};static \u0275cmp=l({type:t,selectors:[["app-landing-layout"]],decls:1,vars:0,template:function(e,n){e&1&&m(0,"router-outlet")},dependencies:[S],encapsulation:2})};var xt=[{path:"",redirectTo:"home",pathMatch:"full"},{path:"",component:ye,children:[{path:"home",loadComponent:()=>import("./chunk-NFL4HMD6.js").then(t=>t.Landing)},{path:"hardware",loadComponent:()=>import("./chunk-AOVKRQV3.js").then(t=>t.Hardware)},{path:"pricing",loadComponent:()=>import("./chunk-UXHJCFZF.js").then(t=>t.Pricing)}]},{path:"",component:ve,children:[{path:"experiments",loadComponent:()=>import("./chunk-JKRSTVXL.js").then(t=>t.Experiments)},{path:"experiments/motor-imagery/unilateral",loadComponent:()=>import("./chunk-H6U57HC5.js").then(t=>t.MotorImageryUnilateral)},{path:"experiments/motor-imagery",loadComponent:()=>import("./chunk-WPYMRBGC.js").then(t=>t.MotorImagery)},{path:"citation",loadComponent:()=>import("./chunk-UIY6UPL5.js").then(t=>t.Quotation)},{path:"glossary",loadComponent:()=>import("./chunk-32Z54KTV.js").then(t=>t.Glossary)},{path:"typography",loadComponent:()=>import("./chunk-SQB67LXG.js").then(t=>t.MaterialLayoutComponent)}]},{path:"",component:xe,children:[{path:"experiments/motor-imagery/unilateral/stimuli",loadComponent:()=>import("./chunk-HBE2WHJ3.js").then(t=>t.StimuliComponent)}]}];var Et={providers:[Le(),Ue({eventCoalescing:!0}),$e(xt),{provide:se,useClass:de}]};var Ee=class t{constructor(r,e,n){this.document=r;this.themeService=e;e.applyMaterialThemeFromColor("#165AB7","html",e.getCurrentMode(),50,50),n.setDefaultFontSetClass("material-symbols-rounded")}static \u0275fac=function(e){return new(e||t)(p(E),p(F),p(ot))};static \u0275cmp=l({type:t,selectors:[["app-root"]],features:[H([{provide:se,useClass:de}])],decls:1,vars:0,template:function(e,n){e&1&&m(0,"router-outlet")},dependencies:[S],encapsulation:2})};je(Ee,Et).catch(t=>console.error(t));
